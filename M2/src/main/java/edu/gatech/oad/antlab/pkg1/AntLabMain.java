 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Benjamin Bohannon");
		  toPrint += p1.toString("bbohannon8");
		  Person2 p2 = new Person2("Connor Schembor");
		  toPrint += p2.toString("cschembor3");
          //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Colin Sharpe");
		  toPrint += p3.toString("csharpe9");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Abhishek Sen");
          toPrint += p4.toString("asen33");
          Person5 p5 = new Person5("Kyle");
          toPrint += p5.toString("kmurray30");
          Person6 p6 = new Person6("Brian");
          toPrint += p6.toString("bmurphy36");
